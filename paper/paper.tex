...
\hypersetup{
	...
	pdfkeywords={Redes Neurais, Regressão, Volatilidade Implícita, Opções, Derivativos},
}
...
\begin{document}
	...
	\keywords{Redes Neurais \and Regressão\and Volatilidade Implícita\and Opções\and Derivativos}
