...
The simplified function for the implied volatility using the SABR model and logarithmic ``moneyness'' $x = \log\left(\frac{K}{F_t}\right)$ is then given by~\cite{Hagan2002}:
\begin{equation*}
    F_t = S e^{(r - q)t}
\end{equation*}
