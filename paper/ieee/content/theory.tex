...
Refer to \Cref{sec:sabr} for the full equation.
...
Using a Deep Equilibrium Model variation for the Implicit Layer, we adapt \Cref{eq:fixed_point} by using the following fixed point equation instead,
