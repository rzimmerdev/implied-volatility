...
\subsection{Resultados e Comparação das Superfícies}
...
\begin{figure}
	\begin{center}
		...
		\caption{Superfície gerada utilizando um modelo SABR com parâmetros otimizados manualmente. Note que a não-seleção manual de contratos candidatos gerou um pico na superfície}
	\end{center}
\end{figure}
...
\begin{figure}
	\begin{center}
		...
		\caption{Comparação da superfície gerada com a arquitetura proposta e superfície baseline. Na esquerda, a superfície do modelo SST, na direita, a superfície interpolada linearmente}
	\end{center}
\end{figure}
